...
class DCCRNNavieComplexLSTM(nn.Module):
    def __init__(
        self,
        input_size,
        hidden_size,
...
class DCCRNComplexConv2d(nn.Module):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        causal: if causal, will padding time dimension's left side,
                otherwise both
        """
        super(DCCRNComplexConv2d, self).__init__()
...
class DCCRNComplexConvTranspose2d(nn.Module):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        out_channels: real+imag
        """
        super(DCCRNComplexConvTranspose2d, self).__init__()
        self.in_channels = in_channels // 2
        self.out_channels = out_channels // 2
        self.kernel_size = kernel_size
        self.stride = stride
...
class DCCRNComplexBatchNorm(torch.nn.Module):
    def __init__(
        self,
        num_features,
        eps=1e-5,
        ...
        super(DCCRNComplexBatchNorm, self).__init__()
